...
(NULL, 'Maestro', 'Maestro.png'),
(NULL, 'Crack', 'Crack.png'),
(NULL, 'Figura', 'Figura.png'),
(NULL, 'Principiante', 'Principiante.png'),
(NULL, 'Fantasma', 'Fantasma.png'),
(NULL, 'Débil', 'Débil.png'),
(NULL, 'Siguiente', 'Siguiente.png');
...
CREATE TABLE IF NOT EXISTS `partida` (
  ...
  `Estado_Partida` enum('En espera','Iniciada','Finalizada') NOT NULL,
  `ID_Mundo` int(15) NOT NULL,
